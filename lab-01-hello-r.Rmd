...
There is 1846 rows and 3 variables. The variables names are **dataset**, **x**, and **y**.  
...
The 'r' of 'star' is -0.0629611, which is less than the 'r' for 'dino' dataset. 
...
The r value of the circle data set is -0.06834336	which is greater than the r value for the dino dataset. 
...
```{r all-viz, echo=FALSE, fig.fullwidth=TRUE}
...
```{r fig-resize-global, echo=FALSE, fig.margin=TRUE, fig.width=3}
...
```{r fig-resize-local, echo=FALSE, fig.height=4, fig.margin=TRUE, fig.width=6}
...
```{r theme-highlight, echo=FALSE, fig.height=5, fig.margin=TRUE, fig.width=7}
